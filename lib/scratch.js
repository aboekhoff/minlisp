...
var listOpen = (0, _parser.lit)("(");
var listClose = (0, _parser.lit)(")");
var list = (0, _parser.bind)(listOpen)(function (_) {
  return (0, _parser.bind)((0, _parser.many)('exprs'))(function (xs) {
    return (0, _parser.bind)(listClose)(function (_) {
      return (0, _parser.lift)(_immutable.Stack);
    });
  });
});

var atom1 = (0, _parser.unless)(whitestuff1)(_parser.token);
var atom = (0, _parser.bind)((0, _parser.many1)(atom1))(_parser.join);

var expr = (0, _parser.skip)(whitestuff)((0, _parser.or)([list, atom]));
var exprs = (0, _parser.many)(expr);

(0, _parser.define)({ exprs: exprs });

console.log(_parser.parsers);
